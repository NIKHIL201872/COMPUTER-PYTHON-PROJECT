...
#ALL THE FUCNTIONS USED THROUGH THE CODE ARE
def loading_screen():
    for i in range(10):
...
def percent(number):
    if stream.lower()=='cse core' or stream.lower()=='cse aiml' or stream.lower()=='cse iotcsbt' or stream.lower()=='cse csbs':
    ...
    with open(f'{path}/Course.csv','r')as f:
        ...
        for i in range(len(rows)):
            if i==0:
                ...
                req+=[rows[i][2]]
        lst=[['COMPUTER PYTHON PROGRAMMING',(req[0].split('-'))[0:-1]],
...
while message:
    ...
    with open(f'{path}/Course.csv','a',newline='')as f:
        script= csv.writer(f)
        script.writerow(['C001','COMPUTER PYTHON PROGRAMMING'])
        script.writerow(['C002','MATHEMATICS'])
    ...
    with open(f'{path}/Department.csv','a',newline='')as f:
        ...
        script.writerow(['CSECSBS','COMPUTER SCIENCE AND ENGINEERING AND BUSINESS SYSTEM'])
        script.writerow(['CSEIOTCSBT','COMPUTER SCIENCE AND ENGINEERING AND CYBER SECURITY AND BLOCKCHAIN TECHNOLOGY'])
...
print('\n','COMPUTER SCIENCE AND ENGINEERING : CSE','\n',
      'COMPUTER SCIENCE AND ENGINEERING AND ARTIFICIAL INTELLIGENCE AND MACHINE LEARNING  : CSEAI','\n',
      'COMPUTER SCIENCE AND ENGINEERING AND BUSINESS SYSTEM : CSBS ','\n',
      ' COMPUTER SCIENCE AND ENGINEERING AND CYBER SECURITY AND BLOCKCHAIN TECHNOLOGY : CSEIOTCSBT','\n',
...
for i in range(student_no):
    ...
    if duplicate('Student.csv',student_id,0):
        ...
        print()
        print("The subjects are [COMPUTER PYTHON PROGRAMMING,MATHEMATICS,PHYSICS,CHEMISTRY,BIOLOGY,ENGLISH]")
